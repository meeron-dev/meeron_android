...
interface TeamRepository {
    ...
    suspend fun deleteTeam(teamId: Long, workspaceUserId: Long): Boolean
    suspend fun addTeamMember(teamId: Long, adminWorkspaceUserId: Long, workspaceUserIds: List<Long>): Boolean
}